...
const CreateReceipt = () => {
  ...
  const { products, addReceipt } = useInventory();
  const [supplier, setSupplier] = useState('');
  const [items, setItems] = useState([{ productId: '', productName: '', quantity: 0, unitPrice: 0 }]);

  const addItem = () => {
    setItems([...items, { productId: '', productName: '', quantity: 0, unitPrice: 0 }]);
  };
  ...
  return (
    <div className="animate-fade-in" data-testid="create-receipt-page">
      <div className="page-header">
        ...
        <p className="page-subtitle">Record incoming goods from supplier</p>
      </div>

      <form onSubmit={handleSubmit} data-testid="create-receipt-form" className="max-w-4xl space-y-6">
        {/* Supplier Info */}
        <div className="card">
          <h3 className="text-lg font-semibold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk' }}>Supplier Information</h3>
          <div>
